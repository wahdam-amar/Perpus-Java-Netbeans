...
DB DB= new DB();
    ...
    public String box(){
        if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("SEMUA")){
            return " like '%' ";
        }else if(jComboBox1.getSelectedItem().toString().equalsIgnoreCase("TELAT")){
            return " ='5000'";
        }else{
            return " ='Tepat Waktu'";
        }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SEMUA", "TELAT", "TEPAT WAKTU" }));
...
//        System.out.print(" STATUS "+box()+" AND tgl_pinjam BETWEEN '"+awal()+"' AND '"+akhir()+"'");
        cetak.cetak("PENGEMBALIAN","denda "+box()+" AND tgl_kembali BETWEEN '"+awal()+"' and '"+akhir()+"'");
